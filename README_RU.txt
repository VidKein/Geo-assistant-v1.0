...
*Настройки:
 ...
 3. Название места расположения работ:
  - Добавление.
  - Удаление.
 4. Работа с точками:
  - Добавление.
  ...
  - Удаление.
 5. Коды типов точек/системы координат:
  - Добавление.
  - Удаление.
 6. Импорт точек в виде списка. 
 ...
 7. Экпорт точек в виде списка.
 Экпортирование списка точек в формате .csv, .txt
 8. Выйти из регистрации. 
