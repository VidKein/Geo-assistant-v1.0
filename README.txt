Целью проекта является оптимизация работы при геодезичечких изысканиях. Проект создан с целью тестирования и опробывания 
...
--------------------------------
Возможности:
- Создание списка точек для проведения геодезических работ. Который находятся .json файле.
    Список сочтоят из : 
    1. Номера точки.
...
*Экспорт/Импорт точек:
    1.Экспорт точек в различные форматы, с возможностью пересылки по почте, месенжеру.
